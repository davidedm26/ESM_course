...
def detect(P1,P2):
    medie1 = ndi.uniform_filder(P1, (127, 127))
    medie2 = ndi.uniform_filder(P2, (127, 127))
    corr12 = ndi.uniform_filder(P1*P2, (127, 127))
...
P1 = np.load('prnu_P1.npy')
P2 = np.load('prnu_P2.npy')
